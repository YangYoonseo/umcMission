...
public class ReviewRestController {
    ...
    public ApiResponse<ReviewResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistStoreId @PathVariable(name = "storeId") Long storeId,@RequestParam(name = "page") Integer page){
